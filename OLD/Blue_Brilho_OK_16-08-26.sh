...
SETTINGS = {
    ...
    "late_night": {
        ...
        "color_temp": 3000,          # meio-termo entre evening(4300) e night(2700)
...
while True:
    ...
    if in_transition:
        ...
        #              morning 4000K e evening 4300K.
        #              4000K e 4300K usam valores interpolados a partir
        #              dos valores anteriores de 3500K e 4500K.
        expected_sct_gamma = {
            2700: "1.0:1.5:2.6",
            3000: "1.0:1.4:2.2",   # late_night
            4000: "1.0:1.25:1.65", # morning
            4300: "1.0:1.22:1.49", # evening
            6500: "1.0:1.0:1.0"
